...
public class MockQuery implements IQueryInformation {
    ...
    public List<String> getPageStream(String pageId, List<String> title) throws QueryException, SplitException {
        ...
        var words = ("Homer Davenport (1867–1912) was a political cartoonist and writer from the United States. " +
                ...
                "paid political cartoonists in the world. He was also one of the first major American breeders of " +
                "Arabian horses and one of the founders of the Arabian Horse Club of America. In 1893 he studied " +
                "and drew the Arabian horses exhibited at the World's Columbian Exposition. In 1904 he drew a " +
                "favorable cartoon of President Theodore Roosevelt that boosted Roosevelt's election campaign. " +
